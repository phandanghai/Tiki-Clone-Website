...
const OrderController = {
   createOrder: async (req, res) => {
      try {
         ...
         if (result) {
            const orders = await OrderModels.checkIsOrderByUserModels({ id_user: req.body.id_user, id_product: req.body.id_product });
   ...
   getOrderByUser: async (req, res) => {
      try {
         const result = await OrderModels.getOrderByUserModels({ id_user: req.body.id_user });
         if (result) {
            return res.status(200).json({
               message: 'Successfully',
               orders: result,
   ...
   checkIsOrderByUser: async (req, res) => {
      try {
         ...
         const result = await OrderModels.checkIsOrderByUserModels({ id_user, id_product });
         if (result) {
            return res.status(200).json({
               message: 'Order exist',
               result: result,
   ...
   updateOrderByUser: async (req, res) => {
      try {
         ...
         const result = await OrderModels.updateOrderByUserModels({ id_order, number_order, status_order, address_order });
         if (result) {
            return res.status(200).json({
   ...
   updateAddressForListOrder: async (req, res) => {
      try {
         ...
         const result = await OrderModels.updateAddressForListOrderModels({ address, listOrder });
         if (result) {
            return res.status(200).json({
   ...
   updateStatusForListOrder: async (req, res) => {
      try {
         ...
         const result = await OrderModels.updateStatusForListOrderModels({ status_order, listOrder });
         if (result) {
            return res.status(200).json({
               message: 'Address updated successfully',
            });
