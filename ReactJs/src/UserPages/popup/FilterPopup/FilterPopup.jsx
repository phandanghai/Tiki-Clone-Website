...
import { ApiGetBrand, ApiGetDataFilter, ApiGetStores } from '@redux/api/ApiProduct';
   ...
   return (
      ...
      >
         <div className="title h-[57px] w-full flex items-center justify-center border-solid border-b-[1px] border-[#ebebf0]">
            ...
            <IoMdClose className="absolute top-5 right-3 hover:cursor-pointer" onClick={() => dispatch(setFilterPopup(false))} />
         </div>
         ...
         <div className="filter-body absolute top-[60px] left-0 w-[570px] h-[415px] px-4 overflow-y-auto overflow-x-hidden">
            <div className="service w-full h-[110px] px-[8px] pt-[21px] flex flex-col gap-3 border-solid border-b-1 border-[#ebebf0]">
               ...
               <div className="flex mt-[6px] ml-[2px] gap-[10px] items-center">
                  ...
                  <img src="https://salt.tikicdn.com/ts/tka/a8/31/b6/802e2c99dcce64c67aa2648edb15dd25.png" alt="" className="w-auto h-5" />
            ...
            <div className="service w-full h-[110px] px-[8px] pt-[24px] flex flex-col gap-3 border-solid border-b-1 border-[#ebebf0]">
               ...
               <div className="flex mt-[6px] ml-[2px] gap-[10px] items-center">
                  <input type="checkbox" className="w-5 h-5" />
                  <img src="https://salt.tikicdn.com/ts/upload/0e/22/93/9b37cf1438ac51f5028bc6ff3deed2a0.png" alt="" className="w-auto h-[17px]" />
                        ...
                        <div key={index} className="star flex items-center gap-3">
                           <input
                              ...
                              onChange={() =>
                                 setFilter({
                                    ...filter,
                                    stars: filter.stars.includes(star) ? filter.stars.filter((s) => s !== star) : [...filter.stars, star],
                                 })
                              }
                           />
            ...
            <div className="price w-full h-[260px] px-2 py-6 flex flex-col gap-[16px] border-solid border-b-[1px]">
                  ...
                  {priceFilter?.map((price) => {
                     return (
                        <div
                           ...
                           checked={filter.minPrice === price.minPrice && filter.maxPrice === price.maxPrice}
                           style={
                              filter.minPrice === price.minPrice && filter.maxPrice === price.maxPrice
               ...
               <div className="myPriceFilter flex flex-col gap-1">
                  <h3 className="font-semibold text-14 text-text-title">Tự nhập khoảng giá</h3>
                  <div className="flex items-center gap-8 py-2 h-20 -mt-4 rounded-md">
                     <div className="minPrice relative h-10 border-solid border-b-[1px] border-[#dddde3]">
                        <input
                           type="text"
                           placeholder=""
                           className="h-10 border-solid border-[1px] border-[#dddde3] outline-none pl-2"
                           onChange={(e) =>
                              setFilter({
                                 ...filter,
                     ...
                     <div className="maxPrice relative h-10 border-solid border-[1px] border-[#dddde3]">
                        <input
                           type="text"
                           className="h-10 border-solid border-b-[1px] border-[#dddde3] outline-none pl-2"
                           onChange={(e) =>
                              setFilter({
                                 ...filter,
                     ...
                     <h2 className="font-medium text-blue-600 hover:cursor-pointer">Xóa</h2>
                  </div>
               </div>
            </div>
               ...
               <div className="list grid grid-cols-2 gap-3">
                  {!isShowBrand ? (
                     <>
                              ...
                              <div className="item flex gap-3 items-center">
                                 <input
                                    ...
                                    onChange={() =>
                                       setFilter({
                                          ...filter,
                                          brand: filter.brand_product.includes(item)
                        ...
                        {brand.length > 5 && (
                           <p className="text-[#5f5e5e] underline hover:cursor-pointer" onClick={() => setIsShowBrand(true)}>
                              Xem thêm
                           </p>
                        )}
                     </>
               ...
               <div className="list grid grid-cols-2 gap-3">
                  {!isShowStores ? (
                     <>
                        ...
                        {stores.length > 5 && (
                           <p className="text-[#5f5e5e] underline hover:cursor-pointer" onClick={() => setIsShowStores(true)}>
                              Xem thêm
                           </p>
                        )}
                     </>
         ...
         <div className="end absolute bottom-0 left-0 h-16 w-full border-solid border-t-[#ddd] border-[1px] flex items-center px-4 hover:cursor-pointer justify-between">
            ...
            <div className="show border-none bg-blue-600 text-white  h-9 w-32 flex items-center justify-center" onClick={handleFilter}>
               <p>Xem kết quả</p>
            </div>
         </div>
      </div>
