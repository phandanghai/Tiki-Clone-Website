...
const BoxName = (props) => {
  return (
    <div className="col-span-5 w-full bg-transparent pt-5 pb-[10px] px-[44px] relative">
      ...
      <h2 className="text-[24px] text-[#000000] font-medium mt-[15px]">
        Nhập thông tin cá nhân
      </h2>
      <p className="text-14 w-[250px]">
        Vui lòng nhập Họ và tên và username của bạn
      </p>
      <input
        type="text"
      ...
      <button
        ...
        onClick={() => props.handleSetState(1)}
      >
        Tiếp tục
      </button>
    </div>
