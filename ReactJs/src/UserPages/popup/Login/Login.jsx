    ...
    >
      ...
      {state === 0 && (
        <BoxEmail
          ...
          handleSetIsUser={handleSetIsUser}
          email={email}
      ...
      {state === 3 && (
        <BoxSMS handleSetState={handleSetState} isForget={isForget} />
      )}
      {state === 4 && (
        <BoxUpdatePassword handleSetState={handleSetState} email={email} />
      )}
      <div
      ...
      >
        <img
          ...
          alt=""
          className="w-[203px] h-max"
        />
        <div className="flex flex-col">
          <h2 className="text-[#0b74e5] text-18 font-medium">
            Mua sắm tại Tiki
          </h2>
          <p className="text-[#0b74e5] text-14 font-normal">
