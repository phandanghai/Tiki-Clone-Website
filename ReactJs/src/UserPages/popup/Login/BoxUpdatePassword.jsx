...
const BoxUpdatePassword = (props) => {
   ...
   const handleUpdatePassword = () => {
      if (password && confirmPassword) {
         if (password === confirmPassword) {
            ...
            ApiUpdatePasswordByEmail({ email: props.email, newPassword: password }).then((data) => {
   ...
   return (
      <div className="col-span-5 w-full bg-transparent pt-9 pb-[25px] px-[44px] relative">
         ...
         />
         <h2 className="text-[24px] text-[#000000] font-medium mt-[37px]">Cập nhật mật khẩu</h2>
         <input
            type="text"
         ...
         <button className="w-full h-[49px] bg-[#ff424e] text-white mt-[40px] text-20" onClick={handleUpdatePassword}>
            Cập nhật
         </button>
      </div>
   );
