...
const BoxSMS = (props) => {
  ...
  return (
    <div className="col-span-5 w-full bg-transparent pt-9 pb-[25px] px-[44px] relative text-black">
      ...
      <h2 className="text-[24px] text-[#000000] font-medium mt-[29px]">
        Nhập mã xác minh
      </h2>
      <p className="text-14 w-[350px] mt-1">
        Số điện thoại 0359170365 đã có tài khoản tại Tiki. Vui lòng xác thực để
        đăng nhập
      </p>
