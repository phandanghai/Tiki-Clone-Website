...
const Slider = () => {
   return (
      <div className="w-[500px] flex gap-3 max-md:flex-col">
         <div className="slide mt-4 w-full h-[168px] flex gap-3 bg-white rounded-md">
            <div>
               <div className="h-[168px] w-[168px] flex items-center justify-center" style={{ backgroundColor: '#afc7b4', borderRadius: 5 }}>
                  <img
            ...
            <div className="content w-full h-full py-4 px-2">
               <h3 className="text-[#38383d] text-[20px] font-medium max-md:text-16">Top Sách Bán Chạy</h3>
               <p className="mt-1 text-14 text-text-span max-md:text-14">Tài trợ bởi 1090 Books tại Tiki Traing</p>
