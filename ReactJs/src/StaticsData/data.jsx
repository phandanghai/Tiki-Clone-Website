...
import Line from '../../public/lineChart.svg';
import Bar from '../../public/chart.svg';
   ...
   },
   {
      ...
      items: [
         ...
         },
         {
            ...
            params: '/san-pham-ve-giay',
         },
         {
            id: 2.3,
            title: 'Dụng cụ học sinh',
            params: '/dung-cu-hoc-sinh',
         },
         {
            id: 2.4,
            title: 'Dụng cụ vẽ',
      ...
      items: [
         {
            ...
            params: '/do-choi-giao-duc',
         },
         {
            id: 3.2,
            title: 'Mô hình các loại',
            params: '/mo-hinh-cac-loai',
         },
         {
            id: 3.3,
            title: 'Đồ chơi vận động',
            params: '/do-choi-van-dong',
         },
         {
            id: 3.4,
            title: 'Đồ chơi thể thao',
            params: '/do-choi-the-thao',
         },
      ],
   },
   {
      ...
      items: [
         {
            ...
            params: '/childrens-books',
         },
         {
            id: 5.2,
            title: `Other Languages`,
            params: '/other-languages',
         },
         {
            id: 5.3,
            title: `Fiction`,
