...
export const ApiCreateProduct = async (product) => {
  try {
    const result = await axios.post(
      `${URL_CALL_API}/api/products/createProduct`,
      product
    );
    return result;
  } catch (error) {
...
export const ApiGetAllProduct = async (dispatch) => {
  try {
    ...
    const result = await axios.get(
      `${URL_CALL_API}/api/products/getAllProduct`
    );
...
export const ApiGetProduct = async ({ id_product }) => {
  try {
    const result = await axios.post(`${URL_CALL_API}/api/products/getProduct`, {
      id_product,
    });
    return result.data;
  } catch (error) {
...
export const ApiDeleteProduct = async ({ id_product }) => {
  try {
    const result = await axios.post(
      `${URL_CALL_API}/api/products/deleteProduct`,
      { id_product }
    );
    return result;
  } catch (error) {
...
export const ApiUploadImage = async (listbase64) => {
  try {
    ...
    const result = await axios.post(
      `${URL_CALL_API}/api/products/uploadImage`,
      listbase64
    );
    return result;
  } catch (err) {
...
export const ApiGetDataFilter = async (dispatch, filter) => {
  try {
    ...
    console.log(filter);
    const result = await axios.post(
      `${URL_CALL_API}/api/products/getDataFilter`,
      filter
    );
...
export const ApiSearchProduct = async (dispatch, { search }) => {
  try {
    dispatch(getProductsStart());
    const result = await axios.post(
      `${URL_CALL_API}/api/products/searchProducts`,
      { search }
    );
    dispatch(getProductsSuccess(result.data.products));
    return result.data;
