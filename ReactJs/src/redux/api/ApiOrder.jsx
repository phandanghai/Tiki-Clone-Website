...
import {
  ...
  setOrderStart,
  setOrderSuccess,
} from "../sliders/AdminStateSlider";
import {
  setOrdersStart,
  setOrdersSuccess,
  setOrdersFailed,
} from "../sliders/orderSilder";
...
export const ApiGetOrderByUser = async (dispatch, { id_user }) => {
  try {
    ...
    const result = await axios.post(
      `${URL_CALL_API}/api/orders/getOrderByUser`,
      {
        id_user,
      }
    );
...
export const ApiCreateOrder = async (
  dispatch,
  { id_user, id_product, number_order, status_order }
) => {
  try {
    dispatch(setOrdersStart());
...
export const ApiGetListOrder = async (listIds) => {
  try {
    const result = await axios.post(
      `${URL_CALL_API}/api/orders/getListOrder`,
      listIds
    );
    return result;
  } catch (error) {
...
export const ApiCheckIsOrderByUser = async ({ id_user, id_product }) => {
  try {
    const result = await axios.post(
      `${URL_CALL_API}/api/orders/checkIsOrderByUser`,
      {
        id_user,
        id_product,
      }
...
export const ApiUpdateOrderByUser = async ({
  id_order,
  status_order,
  number_order,
  address_order,
  ...
  try {
    const result = await axios.post(
      `${URL_CALL_API}/api/orders/updateOrderByUser`,
      {
        id_order,
        status_order,
        number_order,
...
export const ApiUpdateAddressForListOrder = async ({ address, listOrder }) => {
  try {
    const result = await axios.post(
      `${URL_CALL_API}/api/orders/updateAddressForListOrder`,
      {
        address,
        listOrder,
      }
...
export const ApiUpdateStatusForListOrder = async ({
  status_order,
  listOrder,
}) => {
  try {
    const result = await axios.post(
      `${URL_CALL_API}/api/orders/updateStatusForListOrder`,
      {
        status_order,
        listOrder,
      }
...
export const ApiSearchOrderByUser = async (dispatch, { id_user, search }) => {
  try {
    console.log(search);
    dispatch(setOrdersStart());
    const result = await axios.post(
      `${URL_CALL_API}/api/orders/searchOrdersByUser`,
      {
        id_user,
        search,
      }
