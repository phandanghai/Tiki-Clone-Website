...
import { ApiCreateUserAdmin, ApiGetUserById, ApiUpdateUser, ApiUploadAvatar } from '../../../redux/api/ApiUser';
      ...
      <div className="w-full h-[550px] bg-main-bg grid grid-cols-10 gap-4 p-8 text-white overflow-y-auto px-12">
         ...
         <div className="col-span-3 rounded-lg py-6 px-4">
            ...
            <div className="mt-5 w-full p-4 h-[270px] rounded-full">
               <img src={preview || NoImage} alt="" className="w-full h-[254px] rounded-full" />
               <input
                  type="file"
            ...
            {window.location.href.split('/')[6] ? (
               <button className="mt-6 ml-5 w-[250px] h-9 rounded-[8px] bg-[#64748b] z-10" onClick={() => inputRef.current.click()}>
                  Cập nhật avatar cho tài khoản
               </button>
            ) : (
               <button className="mt-6 ml-10 w-[220px] h-9 rounded-[8px] bg-[#64748b] z-10" onClick={() => inputRef.current.click()}>
                  Thêm avatar cho tài khoản
               </button>
            )}
         </div>
         {!window.location.href.split('/')[6] ? (
            <button className="mt-12 ml-52 w-[180px] h-9 rounded-[8px] bg-[#64748b] z-10" onClick={handleCreateUser}>
               Tạo tài khoản mới
            </button>
         ) : (
            <button className="mt-12 ml-52 w-[180px] h-9 rounded-[8px] bg-[#64748b] z-10" onClick={handleUpdateUser}>
               Cập nhật tài khoản
            </button>
         )}
      </div>
